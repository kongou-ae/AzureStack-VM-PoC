...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/kongou-ae/AzureStack-VM-PoC/development/scripts/ASDKHelperModule.psm1" -OutFile "$defaultLocalPath\ASDKHelperModule.psm1"
